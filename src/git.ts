...
const configSuggestions: Fig.Suggestion[] = [
  ...
  },
  {
    ...
    description:
      "Advice shown when git-push fails due to a non-fast-forward update to the current branch",
  },
  {
    name: "advice.pushNonFFMatching",
    description:
      "Advice shown when you ran git-push and pushed matching refs explicitly (i.e. you used :, or specified a refspec that isn’t your current branch) and it resulted in a non-fast-forward error",
  },
  {
    name: "advice.pushAlreadyExists",
    description:
      "Shown when git-push rejects an update that does not qualify for fast-forwarding (e.g., a tag.)",
  },
  {
    name: "advice.pushFetchFirst",
    description:
      "Shown when git-push rejects an update that tries to overwrite a remote ref that points at an object we do not have",
  },
  {
    name: "advice.pushNeedsForce",
    description:
      "Shown when git-push rejects an update that tries to overwrite a remote ref that points at an object that is not a commit-ish, or make the remote ref point at an object that is not a commit-ish",
  },
  {
    name: "advice.statusHints",
    description:
      "Show directions on how to proceed from the current state in the output of git- status(1), in the template shown when writing commit messages in git-commit, and in the help message shown by git-checkout when switching branch",
  },
  {
    name: "advice.statusUoption",
    description:
      "Advise to consider using the -u option to git-status when the command takes more than 2 seconds to enumerate untracked files",
  },
  {
    name: "advice.commitBeforeMerge",
    description:
      "Advice shown when git-merge refuses to merge to avoid overwriting local changes",
  },
  {
  ...
  },
  {
    ...
    description:
      "Advice shown when you used git-checkout to move to the detach HEAD state, to instruct how to create a local branch after the fact",
  },
  {
    name: "advice.amWorkDir",
    description:
      "Advice that shows the location of the patch file when git-am fails to apply it",
  },
  {
    name: "advice.rmHints",
    description:
      "In case of failure in the output of git-rm, show directions on how to proceed from the current state",
  },
  {
    name: "core.fileMode",
    description:
  ...
  },
  {
    ...
    description:
      "If false, the ctime differences between the index and the working tree are ignored; useful when the inode change time is regularly modified by something outside Git (file system crawlers and some backup systems). See git-update-index. True by default",
  },
  {
    name: "core.checkStat",
    description:
  ...
  },
  {
    name: "core.symlinks",
    description:
      "If false, symbolic links are checked out as small plain files that contain the link text.  git-update-index(1) and git-add will not change the recorded type to regular file. Useful on filesystems like FAT that do not support symbolic links",
  },
  {
    name: "core.gitProxy",
    description:
  ...
  },
  {
    name: "core.bare",
    description:
      "If true this repository is assumed to be bare and has no working directory associated with it. If this is the case a number of commands that require a working directory will be disabled, such as git-add(1) or git-merge",
  },
  {
    name: "core.worktree",
    description:
  ...
  },
  {
    name: "core.editor",
    description:
      "Commands such as commit and tag that lets you edit messages by launching an editor uses the value of this variable when it is set, and the environment variable GIT_EDITOR is not set. See git-var",
  },
  {
  ...
  },
  {
    ...
    description: "This boolean will enable fsync() when writing object files",
  },
  {
  ...
  },
  {
    ...
    description:
      'Enable "sparse checkout" feature. See section "Sparse checkout" in git-read-tree for more information',
  },
  {
    name: "core.abbrev",
    description:
  ...
  {
    name: "add.ignoreErrors",
    description:
      "Tells git add to continue adding files when some files cannot be added due to indexing errors. Equivalent to the --ignore-errors option of git-add.  add.ignore-errors is deprecated, as it does not follow the usual naming convention for configuration variables",
  },
  {
    name: "alias.*",
  ...
  },
  {
    ...
    description:
      "When set to change, tells git apply to ignore changes in whitespace, in the same way as the --ignore-space-change option. When set to one of: no, none, never, false tells git apply to respect all whitespace differences. See git-apply",
  },
  {
    name: "apply.whitespace",
    description:
      "Tells git apply how to handle whitespaces, in the same way as the --whitespace option. See git-apply",
  },
  {
    name: "branch.autoSetupMerge",
    description:
      "Tells git branch and git checkout to set up new branches so that git-pull will appropriately merge from the starting point branch. Note that even if this option is not set, this behavior can be chosen per-branch using the --track and --no-track options. The valid settings are: false — no automatic setup is done; true — automatic setup is done when the starting point is a remote-tracking branch; always —  automatic setup is done when the starting point is either a local branch or remote-tracking branch. This option defaults to true",
  },
  {
  ...
  },
  {
    ...
    description:
      "Specify the command to invoke the specified browser. The specified command is evaluated in shell with the URLs passed as arguments. (See git-web--browse.)",
  },
  {
    name: "browser.&lt;tool&gt;.path",
    insertValue: "browser.{cursor}.path",
    description:
      "Override the path for the given tool that may be used to browse HTML help (see -w option in git-help(1)) or a working repository in gitweb (see git-instaweb)",
  },
  {
  ...
  },
  {
    name: "color.branch",
    description:
      "A boolean to enable/disable color in the output of git-branch. May be set to always, false (or never) or auto (or true), in which case colors are used only when the output is to a terminal. Defaults to false",
  },
  {
  ...
  },
  {
    name: "color.diff",
    description:
      "Whether to use ANSI escape sequences to add color to patches. If this is set to always, git-diff(1), git-log(1), and git-show will use color for all patches. If it is set to true or auto, those commands will only use color when output is to the terminal. Defaults to false",
  },
  {
  ...
  },
  {
    ...
    description:
      "Use customized color for grep colorization.  <slot> specifies which part of the line to use the specified color",
  },
  {
  ...
  },
  {
    ...
    description:
      "A boolean to enable/disable color in the output of git-show-branch. May be set to always, false (or never) or auto (or true), in which case colors are used only when the output is to a terminal. Defaults to false",
  },
  {
    name: "color.status",
    description:
      "A boolean to enable/disable color in the output of git-status. May be set to always, false (or never) or auto (or true), in which case colors are used only when the output is to a terminal. Defaults to false",
  },
  {
  ...
  },
  {
    name: "diff.dirstat",
    description:
      "A comma separated list of --dirstat parameters specifying the default behavior of the --dirstat option to git-diff` and friends. The defaults can be overridden on the command line (using --dirstat=<param1,param2,...>). The fallback defaults (when not changed by diff.dirstat) are changes,noncumulative,3",
  },
  {
  ...
  },
  {
    name: "diff.orderFile",
    description:
      "File indicating how to order files within a diff, using one shell glob pattern per line. Can be overridden by the -O option to git-diff",
  },
  {
  ...
  },
  {
    name: "diff.submodule",
    description:
      'Specify the format in which differences in submodules are shown. The "log" format lists the commits in the range like git-submodule summary does. The "short" format format just shows the names of the commits at the beginning and end of the range. Defaults to short',
  },
  {
    name: "diff.wordRegex",
    description:
  ...
  },
  {
    name: "format.attach",
    description:
      "Enable multipart/mixed attachments as the default for format-patch. The value can also be a double quoted string which will enable attachments as the default and set the value as the boundary. See the --attach option in git-format-patch",
  },
  {
    name: "format.numbered",
    description:
      'A boolean which can enable or disable sequence numbers in patch subjects. It defaults to "auto" which enables it only if there is more than one patch. It can be enabled or disabled for all messages by setting it to "true" or "false". See --numbered option in git-format-patch',
  },
  {
    name: "format.headers",
    description:
  ...
  },
  {
    name: "format.to",
    description:
      "Additional recipients to include in a patch to be submitted by mail. See the --to and --cc options in git-format-patch",
  },
  {
    name: "format.cc",
    description:
  ...
  },
  {
    ...
    description:
      'The default for format-patch is to output a signature containing the Git version number. Use this variable to change that default. Set this variable to the empty string ("")',
  },
  {
  ...
  },
  {
    name: "format.pretty",
    description:
      "The default pretty format for log/show/whatchanged command, See git-log, git- show(1), git-whatchanged",
  },
  {
    name: "format.thread",
    description:
  ...
  },
  {
    ...
    description:
      "Records of conflicted merge you resolved earlier are kept for this many days when git rerere gc is run. The default is 60 days. See git-rerere",
  },
  {
    name: "gc.rerereUnresolved",
    description:
      "Records of conflicted merge you have not resolved are kept for this many days when git rerere gc is run. The default is 15 days. See git-rerere",
  },
  {
  ...
  },
  {
    name: "gitcvs.enabled",
    description:
      "Whether the CVS server interface is enabled for this repository. See git-cvsserver",
  },
  {
    name: "gitcvs.logFile",
    description:
  ...
  },
  {
    ...
    description:
      "Used Perl DBI driver. You can specify any available driver for this here, but it might not work. git-cvsserver is tested with DBD::SQLite, reported to work with DBD::Pg, and reported not to work with DBD::mysql. Experimental feature. May not contain double colons (:). Default: SQLite. See git-cvsserver",
  },
  {
    name: "gitcvs.dbUser",
    description:
      "Database user and password. Only useful if setting gitcvs.dbDriver, since SQLite has no concept of database users and/or passwords.  gitcvs.dbUser supports variable substitution (see git-cvsserver for details)",
  },
  {
    name: "gitcvs.dbPass",
    description:
  ...
  },
  {
    ...
    description:
      "Database table name prefix. Prepended to the names of any database tables used, allowing a single database to be used for several repositories. Supports variable substitution (see git-cvsserver for details). Any non-alphabetic characters will be replaced with underscores",
  },
  { name: "gitweb.category", description: "See gitweb(1) for description" },
  { name: "gitweb.description", description: "See gitweb(1) for description" },
  { name: "gitweb.owner", description: "See gitweb(1) for description" },
  { name: "gitweb.url", description: "See gitweb(1) for description" },
  { name: "gitweb.avatar", description: "See gitweb.conf(5) for description" },
  { name: "gitweb.blame", description: "See gitweb.conf(5) for description" },
  { name: "gitweb.grep", description: "See gitweb.conf(5) for description" },
  {
    name: "gitweb.highlight",
    description: "See gitweb.conf(5) for description",
  },
  { name: "gitweb.patches", description: "See gitweb.conf(5) for description" },
  { name: "gitweb.pickaxe", description: "See gitweb.conf(5) for description" },
  {
    name: "gitweb.remote_heads",
    description: "See gitweb.conf(5) for description",
  },
  {
    name: "gitweb.showSizes",
    description: "See gitweb.conf(5) for description",
  },
  {
  ...
  },
  {
    ...
    description:
      'Defines how wide the commit message window is in the git-gui"75" is the default',
  },
  {
  ...
  },
  {
    ...
    description:
      'Determines if :git-gui shows untracked files in the file list. The default is "true"',
  },
  {
    name: "gui.encoding",
    description:
      "Specifies the default encoding to use for displaying of file contents in git-gui and gitk(1). It can be overridden by setting the encoding attribute for relevant files (see gitattributes(5)). If this option is not set, the tools default to the locale encoding",
  },
  {
    name: "gui.matchTrackingBranch",
    description:
      'Determines if new branches created with git-gui should default to tracking remote branches with matching names or not. Default: "false"',
  },
  {
    name: "gui.newBranchTemplate",
    description:
      "Is used as suggested name when creating new branches using the git-gui",
  },
  {
  ...
  },
  {
    name: "gui.trustmtime",
    description:
      "Determines if git-gui should trust the file modification timestamp or not. By default the timestamps are not trusted",
  },
  {
    name: "gui.spellingDictionary",
    description:
      'Specifies the dictionary used for spell checking commit messages in the git-gui. When set to "none" spell checking is turned off',
  },
  {
  ...
  },
  {
    ...
    description:
      "Specifies the threshold to use in git gui blame original location detection, measured in alphanumeric characters. See the git-blame manual for more information on copy detection",
  },
  {
  ...
  },
  {
    name: "help.format",
    description:
      "Override the default help format used by git-help. Values man, info, web and html are supported.  man is the default.  web and html are the same",
  },
  {
  ...
  },
  {
    ...
    description:
      "Character encoding the commit messages are stored in; Git itself does not care per se, but this information is necessary e.g. when importing commits from emails or in the gitk graphical history browser (and possibly at other places in the future or in other porcelains). See e.g.  git-mailinfo. Defaults to utf-8",
  },
  {
  ...
  },
  {
    name: "imap",
    description:
      "The configuration variables in the imap section are described in git-imap-send",
  },
  {
    name: "index.version",
    description:
  ...
  },
  {
    ...
    description:
      "Specify the program that will be used to browse your working repository in gitweb. See git-instaweb",
  },
  {
    name: "instaweb.httpd",
    description:
  ...
  },
  {
    name: "instaweb.local",
    description:
      "If true the web server started by git-instaweb will be bound to the local IP (127.0.0.1)",
  },
  {
    name: "instaweb.modulePath",
    description:
      "The default module path for git-instaweb to use instead of /usr/lib/apache2/modules. Only used if httpd is Apache",
  },
  {
    name: "instaweb.port",
    description:
      "The port number to bind the gitweb httpd to. See git-instaweb",
  },
  {
    name: "interactive.singleKey",
    description:
      "In interactive commands, allow the user to provide one-letter input with a single key (i.e., without hitting enter). Currently this is used by the --patch mode of git- add(1), git-checkout(1), git-commit(1), git-reset(1), and git-stash. Note that this setting is silently ignored if portable keystroke input is not available; requires the Perl module Term::ReadKey",
  },
  {
    name: "log.abbrevCommit",
    description:
      "If true, makes git-log(1), git-show(1), and git-whatchanged assume --abbrev-commit. You may override this option with --no-abbrev-commit",
  },
  {
    name: "log.date",
    description:
      "Set the default date-time mode for the log command. Setting a value for log.date is similar to using git log's --date option. See git-log for details",
  },
  {
    name: "log.decorate",
    description:
  ...
  },
  {
    name: "log.showRoot",
    description:
      "If true, the initial commit will be shown as a big creation event. This is equivalent to a diff against an empty tree. Tools like git-log(1) or git-whatchanged, which normally hide the root commit will now show it. True by default",
  },
  {
    name: "log.mailmap",
    description:
      "If true, makes git-log(1), git-show(1), and git-whatchanged assume --use-mailmap",
  },
  {
    name: "mailinfo.scissors",
    description:
      'If true, makes git-mailinfo(1) (and therefore git-am) act by default as if the --scissors option was provided on the command-line. When active, this features removes everything from the message body before a scissors line (i.e. consisting mainly of ">8", "8<" and "-")',
  },
  {
    name: "mailmap.file",
    description:
  ...
  },
  {
    ...
    description:
      "Specify the command to invoke the specified man viewer. The specified command is evaluated in shell with the man page passed as argument. (See git-help.)",
  },
  {
    name: "man.&lt;tool&gt;.path",
    insertValue: "man.{cursor}.path",
    description:
      "Override the path for the given tool that may be used to display help in the man format. See git-help",
  },
  {
  ...
  },
  {
    ...
    description:
      'Which merge strategy to choose by default when resolving notes conflicts. Must be one of manual, ours, theirs, union, or cat_sort_uniq. Defaults to manual. See "NOTES MERGE STRATEGIES" section of git-notes for more information on each strategy',
  },
  {
    name: "notes.&lt;name&gt;.mergeStrategy",
    insertValue: "notes.{cursor}.mergeStrategy",
    description:
      'Which merge strategy to choose when doing a notes merge into refs/notes/<name>. This overrides the more general "notes.mergeStrategy". See the "NOTES MERGE STRATEGIES" section in git-notes for more information on the available strategies',
  },
  {
  ...
  },
  {
    name: "pack.window",
    description:
      "The size of the window used by git-pack-objects when no window size is given on the command line. Defaults to 10",
  },
  {
    name: "pack.depth",
    description:
      "The maximum delta depth used by git-pack-objects when no maximum depth is given on the command line. Defaults to 50",
  },
  {
    name: "pack.windowMemory",
    description:
      'The maximum size of memory that is consumed by each thread in git-pack-objects for pack window memory when no limit is given on the command line. The value can be suffixed with "k", "m", or "g". When left unconfigured (or set explicitly to 0), there will be no limit',
  },
  {
  ...
  },
  {
    ...
    description:
      "The maximum memory in bytes used for caching deltas in git-pack-objects before writing them out to a pack. This cache is used to speed up the writing object phase by not having to recompute the final delta result once the best match for all objects is found. Repacking large repositories on machines which are tight with memory might be badly impacted by this though, especially if this cache pushes the system into swapping. A value of 0 means no limit. The smallest size of 1 byte may be used to virtually disable this cache. Defaults to 256 MiB",
  },
  {
    name: "pack.deltaCacheLimit",
    description:
      "The maximum size of a delta, that is cached in git-pack-objects. This cache is used to speed up the writing object phase by not having to recompute the final delta result once the best match for all objects is found. Defaults to 1000",
  },
  {
    name: "pack.threads",
    description:
  ...
  },
  {
    ...
    description:
      "The maximum size of a pack. This setting only affects packing to a file when repacking, i.e. the git:// protocol is unaffected. It can be overridden by the --max-pack-size option of git-repack. The minimum size allowed is limited to 1 MiB. The default is unlimited. Common unit suffixes of k, m, or g are supported",
  },
  {
  ...
  {
    name: "pack.writeBitmaps (deprecated)",
  ...
  },
  {
    ...
    description:
      'Alias for a --pretty= format string, as specified in git-log. Any aliases defined here can be used just as the built-in pretty formats could. For example, running git config pretty.changelog "format:* %H %s" would cause the invocation git log --pretty=changelog to be equivalent to running git log "--pretty=format:* %H %s". Note that an alias with the same name as a built-in format will be silently ignored',
  },
  {
    name: "pull.ff",
    description:
  ...
  },
  {
    name: "push.gpgSign",
    description:
      "May be set to a boolean value, or the string if-asked. A true value causes all pushes to be GPG signed, as if --signed is passed to git-push. The string if-asked causes pushes to be signed if the server supports it, as if --signed=if-asked is passed to git push. A false value may override a value from a lower-priority config file. An explicit command-line flag always overrides this config option",
  },
  {
  ...
  },
  {
    ...
    description: "The URL of a remote repository. See git-fetch(1) or git-push",
  },
  {
    name: "remote.&lt;name&gt;.pushurl",
    insertValue: "remote.{cursor}.pushurl",
    description: "The push URL of a remote repository. See git-push",
  },
  {
  ...
  },
  {
    ...
    description: 'The default set of "refspec" for git-fetch(1). See git-fetch',
  },
  {
    name: "remote.&lt;name&gt;.push",
    insertValue: "remote.{cursor}.push",
    description: 'The default set of "refspec" for git-push(1). See git-push',
  },
  {
  ...
  },
  {
    ...
    description:
      "If true, this remote will be skipped by default when updating using git-fetch or the update subcommand of git-remote",
  },
  {
  ...
  },
  {
    ...
    description:
      "The default program to execute on the remote side when pushing. See option --receive-pack of git-push",
  },
  {
    name: "remote.&lt;name&gt;.uploadpack",
    insertValue: "remote.{cursor}.uploadpack",
    description:
      "The default program to execute on the remote side when fetching. See option --upload-pack of git-fetch-pack",
  },
  {
    name: "remote.&lt;name&gt;.tagOpt",
    insertValue: "remote.{cursor}.tagOpt",
    description:
      "Setting this value to --no-tags disables automatic tag following when fetching from remote <name>. Setting it to --tags will fetch every tag from remote <name>, even if they are not reachable from remote branch heads. Passing these flags directly to git- fetch(1) can override this setting. See options --tags and --no-tags of git-fetch",
  },
  {
  ...
  },
  {
    ...
    description:
      'By default, git-repack creates packs that use delta-base offset. If you need to share your repository with Git older than version 1.4.4, either directly or via a dumb protocol such as http, then you need to set this option to "false" and repack. Access from old Git versions over the native protocol are unaffected by this option',
  },
  {
  ...
  },
  {
    name: "rerere.enabled",
    description:
      'Activate recording of resolved conflicts, so that identical conflict hunks can be resolved automatically, should they be encountered again. By default, git-rerere is enabled if there is an rr-cache directory under the $GIT_DIR, e.g. if "rerere" was previously used in the repository',
  },
  {
  ...
  },
  {
    ...
    description:
      "See git-send-email for description. Note that this setting is not subject to the identity mechanism",
  },
  {
    name: "sendemail.smtpssl (deprecated)",
    description: "Deprecated alias for sendemail.smtpEncryption = ssl",
  },
  {
  ...
  {
    name: "sendemail.envelopeSender",
    description: "See git-send-email for description",
  },
  { name: "sendemail.from", description: "See git-send-email for description" },
  {
    name: "sendemail.multiEdit",
    description: "See git-send-email for description",
  },
  {
    name: "sendemail.signedoffbycc",
    description: "See git-send-email for description",
  },
  {
  ...
  {
    name: "sendemail.suppresscc",
    description: "See git-send-email for description",
  },
  {
    name: "sendemail.suppressFrom",
    description: "See git-send-email for description",
  },
  { name: "sendemail.to", description: "See git-send-email for description" },
  {
    name: "sendemail.smtpDomain",
    description: "See git-send-email for description",
  },
  {
  ...
  {
    name: "sendemail.smtpServerOption",
    description: "See git-send-email for description",
  },
  {
  ...
  {
    name: "sendemail.signedoffcc (deprecated)",
    description: "Deprecated alias for sendemail.signedoffbycc",
  },
  {
    name: "showbranch.default",
    description:
      "The default set of branches for git-show-branch(1). See git-show-branch",
  },
  {
    name: "status.relativePaths",
    description:
      "By default, git-status shows paths relative to the current directory. Setting this variable to false shows paths relative to the repository root (this was the default for Git prior to v1.5.4)",
  },
  {
    name: "status.short",
    description:
      "Set to true to enable --short by default in git-status. The option --no-short takes precedence over this variable",
  },
  {
    name: "status.branch",
    description:
      "Set to true to enable --branch by default in git-status. The option --no-branch takes precedence over this variable",
  },
  {
    name: "status.displayCommentPrefix",
    description:
      "If set to true, git-status will insert a comment prefix before each output line (starting with core.commentChar, i.e.  # by default). This was the behavior of git- status(1) in Git 1.8.4 and previous. Defaults to false",
  },
  {
    name: "status.showUntrackedFiles",
    description:
      "By default, git-status(1) and git-commit show files which are not currently tracked by Git. Directories which contain only untracked files, are shown with the directory name only. Showing untracked files means that Git needs to lstat() all the files in the whole repository, which might be slow on some systems. So, this variable controls how the commands displays the untracked files",
  },
  {
    name: "status.submoduleSummary",
    description:
      "Defaults to false. If this is set to a non zero number or true (identical to -1 or an unlimited number), the submodule summary will be enabled and a summary of commits for modified submodules will be shown (see --summary-limit option of git-submodule). Please note that the summary output command will be suppressed for all submodules when diff.ignoreSubmodules is set to all or only for those submodules where submodule.<name>.ignore=all. The only exception to that rule is that status and commit will show staged submodule changes. To also view the summary for ignored submodules you can either use the --ignore-submodules=dirty command-line option or the git submodule summary command, which shows a similar output but does not honor these settings",
  },
  {
  ...
  },
  {
    ...
    insertValue: "submodule.{cursor}.path",
    description:
      "The path within this project and URL for a submodule. These variables are initially populated by git submodule init. See git-submodule and gitmodules(5) for details",
  },
  {
  ...
  },
  {
    ...
    description:
      "The remote branch name for a submodule, used by git submodule update --remote. Set this option to override the value found in the .gitmodules file. See git-submodule and gitmodules(5) for details",
  },
  {
  ...
  },
  {
    ...
    priority: 76,
    description:
      "Your full name to be recorded in any newly created commits. Can be overridden by the GIT_AUTHOR_NAME and GIT_COMMITTER_NAME environment variables. See git-commit-tree",
  },
  {
    name: "user.signingKey",
    description:
      "If git-tag(1) or git-commit is not selecting the key you want it to automatically when creating a signed tag or commit, you can override the default selection with this variable. This option is passed unchanged to gpg’s --local-user parameter, so you may specify a key using any method that gpg supports",
  },
  {
    name: "versionsort.prereleaseSuffix",
    description:
      'When version sort is used in git-tag, prerelease tags (e.g"1.0-rc1") may appear after the main release "1.0". By specifying the suffix "-rc" in this variable, "1.0-rc1" will appear before "1.0"',
  },
  {
    name: "web.browser",
    description:
      "Specify a web browser that may be used by some commands. Currently only git- instaweb(1) and git-help may use it",
  },
];
